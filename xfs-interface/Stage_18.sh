...
load --init $HOME/myexpos/Stage_17/assg1.xsm
...
load --int=9 $HOME/myexpos/Stage_18/int_9.xsm
load --int=disk $HOME/myexpos/Stage_18/int_2.xsm
load --module 7 $HOME/myexpos/Stage_18/module_7.xsm
...
load --module 1 $HOME/myexpos/Stage_17/module_1.xsm
load --module 2 $HOME/myexpos/Stage_17/module_2.xsm
rm odd_nos.xsm
